...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QBaseKit/QBaseKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QBusiness/QBusiness.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QDevice/QDevice.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QFeature/QFeature.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QUtil/QUtil.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RegexKitLite-NoWarning/RegexKitLite_NoWarning.framework"
  ...
  install_framework "${PODS_ROOT}/../../DevelopPods/flutter_module/.ios/Flutter/App.framework"
